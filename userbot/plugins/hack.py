...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if idd==709096827:
            await event.edit("This is My Master\nI can't hack my master's Account\n**How dare you trying to hack my master's account nigga!**\n\n__Your account has been hacked! Pay 69$ to my master__ [Shadow Ninja](tg://user?id=709096827) __to release your account__😏🖕🏻")
        else:
