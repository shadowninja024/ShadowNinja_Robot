...
async def _(event):
   ...
   # if input_str == "call":
    ...
    animation_chars = [
            ...
            "`Me: Yo this is` @Shadow_ninja_legit ,`Please Connect me to my lil bro,Pavel Durov`",
            "`User Authorised.`",
            "`Calling Pavel Durov`  `At +916969696969`",
            "`Private  Call Connected...`",
            "`Me: Hello Sir, Please Ban This Telegram Account.`",    
            "`Pavel: May I Know Who Is This?`",
            "`Me: Yo Bro, I Am` @Shadow_ninja_legit ",
            "`Pavel: OMG!!! Long time no see, Wassup Brother...\nI'll Make Sure That Guy Account Will Get Blocked Within 24Hrs.`",
            "`Me: Thanks, See You Later Bro.`",
            "`Pavel: Please Don't Thank Bro, Telegram Is Our's. Just Gimme A Call When You Become Free.`",
